...
export const Basic: Story = {
  render: () => (
    <div className="w-[90vw] flex justify-center">
      <BPContainer className="p-16 flex flex-col gap-12 w-[100%] lg:w-[50%] border-neutral-200 dark:border-neutral-900 text-center border-dashed border-4 rounded-md">
...
const SizeDefault = ({ size }: any) => (
  <BPContainer
    size={size}
    className="p-6 flex flex-col gap-2 w-[100%] border-neutral-200 dark:border-neutral-900 text-center border-dashed border-4 rounded-md"
  >
...
export const Sizes: Story = {
  render: () => (
    <div className="w-[90vw] flex items-center flex-col justify-center gap-2">
      <SizeDefault size="xs" />
      <SizeDefault size="sm" />
      <SizeDefault size="lg" />
      <SizeDefault size="xl" />
