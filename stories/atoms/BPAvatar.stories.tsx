...
export const Types: Story = {
  render: () => (
    <div className="w-full flex flex-row flex-wrap justify-center gap-16 overflow-y-auto h-[90vh] px-12 py-5 md:px-0">
      <div className="flex flex-col flex-wrap gap-8 items-center">
        <div className="text-xl text-primary-600">Normal</div>
        {Object.keys(UI_TYPES_CONFIG).map((key, index) => (
          <BPAvatar key={index} variant={key as UI_VARIANT} text="J M" />
        ))}
      </div>
...
export const Combined: Story = {
  render: () => (
    <div className="flex flex-col gap-6 justify-center items-center">
      <div className="text-xl text-center text-primary-600">
